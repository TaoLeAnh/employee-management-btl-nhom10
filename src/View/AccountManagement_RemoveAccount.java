...
public class AccountManagement_RemoveAccount extends JFrame {
    ...
    public AccountManagement_RemoveAccount() {
    ...
    public void init() {
        ...
        usernameTextField.setBounds(393, 50, 285, 30);
        ...
        nhapTenTaiKhoanText.setBounds(393, 10, 186, 30);
    ...
    public void remove_account() {
    	...
    	else if (res == 2) JOptionPane.showMessageDialog(this, "Xóa tài khoản thành công!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
