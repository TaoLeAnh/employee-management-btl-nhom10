...
public class Login extends JFrame {
	...
	private AccountManagement_Main amm;		/* Khai báo thêm thuộc tính cần thiết (Giao diện đó có các chức năng nào 
											thì bổ sung thuộc tính quản lý các chức năng đó,
											amm là class quản lý các chức năng của tài khoản (Nhớ viết lại class này (amm) như sau: 	
											bỏ hàm main đi, bỏ các lựa chọn menu đi mỗi lựa chọn trong menu bây giờ sẽ trở thành 
											một phương thức (Để các phương thức đó được sử dụng
											tại class giao diện thông qua thuộc tính đc thêm vào, ở đây là amm) */
	...
	public void init() {			//Hàm này ban đầu là hàm khởi tạo
		...
		signUpButton.addActionListener(new ActionListener() {		//khi ấn nút signup chuyển qua giao diện SignUp
            public void actionPerformed(ActionEvent e) {
                SignUp signUpFrame = new SignUp();
                signUpFrame.setVisible(true);		//hiển thị giao diện SignUp
