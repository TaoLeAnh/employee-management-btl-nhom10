...
public class DepartmentManagement_SearchResult extends JFrame {

    private static final long serialVersionUID = 1L;
    private JPanel contentPane;

    public DepartmentManagement_SearchResult(String id, String departmentName, String address, String phoneNumber) {
		this.init(id, departmentName, address, phoneNumber);
		setVisible(true);
	}

    public void init(String id, String departmentName, String address, String phoneNumber) {
