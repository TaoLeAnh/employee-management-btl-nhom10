...
public class DepartmentManagement_View extends JFrame {
    ...
    public DepartmentManagement_View() {
    	String[] columnNames = {
    ...
    public void init() {
        ...
        addEmployeeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	DepartmentManagement_AddDepartment newFrame = new DepartmentManagement_AddDepartment();
                newFrame.setVisible(true);
                dispose();
            }
        });
        ...
        editEmployeeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	DepartmentManagement_EditDepartment newFrame = new DepartmentManagement_EditDepartment();
                newFrame.setVisible(true);
                dispose();
            }
        });
        ...
        removeEmployeeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	DepartmentManagement_RemoveDepartment newFrame = new DepartmentManagement_RemoveDepartment();
                newFrame.setVisible(true);
                dispose();
            }
        });
    ...
    public void loadDepartmentData() {
        String filePath = "D:\\Study\\Code\\Java\\employeeManagerSoftware_Group10\\Department.txt";
	    ...
	    try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
	        ...
	        while ((line = br.readLine()) != null) {
	            ...
	            if (departmentData.length == 4 && departmentData[0].equals(id)) {
	            	...
	            	DepartmentManagement_SearchResult searchResultFrame = new DepartmentManagement_SearchResult(departmentData[0], 
