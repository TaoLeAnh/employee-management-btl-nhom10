...
public class AccountManagement_View extends JFrame {
	...
	public void loadAccountData() {
        String filePath = "D:\\Study\\Code\\Java\\employeeManagerSoftware_Group10\\Account.txt";
	    ...
	    try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
	        ...
	        while ((line = br.readLine()) != null) {
	            ...
	            if (accountData.length == 2 && accountData[0].equals(searchUsername)) {
	            	...
	            	AccountManagement_SearchResult searchResultFrame = new AccountManagement_SearchResult(username, password);
